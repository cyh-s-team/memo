...
import com.example.myapplication.PepareClass.SQLBean;
...
public class Search extends Activity {
    ...
    private void showNotesList() {
        ...
        if (cursor.getCount() > 0) {
            ...
            Toast.makeText(Search.this, "暂无记事！",
    ...
    class ItemClickEvent implements OnItemClickListener {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position,
            ...
            if ("0".equals(locktype)) {
                Intent intent = new Intent(Search.this, Addnote.class);
    ...
    public void inputTitleDialog(final String lock, final int idtype,
        ...
        builder.setPositiveButton("确认", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if ("".equals(inputName)) {
                    Toast.makeText(Search.this, "密码不能为空请重新输入！",
                            Toast.LENGTH_LONG).show();
                } else {
                    if (inputName.equals(lock)) {
                        ...
                        Toast.makeText(Search.this, "密码不正确！",
                                Toast.LENGTH_LONG).show();
                    }
                }
            }
    ...
    public void onSearch(View v) {
        ...
        if ("".equals(ek)) {
            Toast.makeText(Search.this, "请输入关键词！", Toast.LENGTH_LONG)
                    .show();
        } else {
            keword=ek;
            showNotesList();
